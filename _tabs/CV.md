...
h1, h2, h3 {
font-weight: 400; /* A lighter weight for a clean, modern feel */
}
h1 {
font-size: 2.5em;
...
h2 {
font-size: 1.8em;
border-bottom: 1px solid #eee; /* Subtle underline for section headers */
padding-bottom: 5px;
margin-top: 1.5em;
}
h3 {
font-size: 1.2em;
font-weight: 700; /* Bolder for titles/degrees */
margin-bottom: 0.1em;
}
p, li {
font-size: 1em;
font-weight: 300; /* Light text for readability */
}
ul {
padding-left: 20px;
...
height: 1px;
background: #ddd;
margin: 2.5em 0; /* Generous spacing */
}
...
/* Style for CV entries (work, education) */
/* This class is no longer used for Work Experience, but kept for Education etc. */
.cv-entry {
margin-bottom: 1.5em;
}
.cv-entry p {
...
/* Using <strong> for company/school and <em> for date */
.cv-meta {
font-size: 1em;
font-weight: 400;
color: #555;
...
a {
color: #007bff; /* A standard, accessible blue link color */
text-decoration: none;
}
a:hover {
text-decoration: underline;
}
/* Style for the new publications list */
.pub-list {
padding-left: 0;
list-style-type: none;
}
.pub-list li {
margin-bottom: 1em; /* Space out each publication */
line-height: 1.5;
}
</style>
...
<p>
RF Field Applications Engineer, Analog Devices
...
<a href="mailto:livethisdream@gmail.com">livethisdream@gmail.com</a> | <a href=" https://www.linkedin.com/in/neil-rogers-rf/">Linkedin</a> | <a href="https://scholar.google.com/citations?user=3mF8eAwAAAAJ&hl=en">Google Scholar</a>
</p>
</div>
<br>
...
I am a technology builder with proven expertise in tackling the hardest problems, by collaborating and elevating others along the way. I look at everything I see and ask, "how can I make this better?" adding value to everything I touch is my greatest professional passion. I excel in a team environment and bring a proactive, positive attitude to every situation. I aim to contribute to meaningful, high-impact R&D while cultivating a team culture rooted in technical depth, integrity, and trust.
...
### Family
* Kristi: wife of 20 years
* Judah: son, 15 years old
* Ezra: son, 13 years old
* Luka: son, 10 years old
* Aviana: daughter, 8 years old
...
* GNURadio Conference Technical Chair, 2025
* USAFA Falcon Crossfit Officer-in-Charge, 2021-2025
* Band Member (2006-Present), Church Band Leader (2006-2009, 2015)
* Small Group Leader (2005-2022)
* Led collection of 1k+ Operation Christmas Child Boxes (2016-2018)
* Youth Ministry Leader (2005-2007)
* Youth Soccer Coach (2014-2015, 2018-2019)
* Led and organized STEM outreach for 7k+ students at annual SpaceFest (2013)
* Elementary math tutor (2011-2014)
* Monthly volunteer at Target Dayton Homeless Shelter (2005-2009)
