# GRCon 25 CTF Challenges (spoilers)
...
<figure>
  <img src="/img/grcon25-ctf/atsc-spectrum.png" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Spectrum of ATSC signal. The combination of a flat-topped signal that is roughly 6 MHz wide (the span between the roughly flat sides of the signal) and the spectral line on the left end are all indicative of a ATSC signal, specifically ATSC Ver 1.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/gr-atsc-demod.jpg" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Flowgraph to demodulate and decode an ATSC Ver 1 signal. This flowgraph saves the output of the ATSC Receive Pipeline to a file. NOTE: The SigMF Source block is set to a "Repeat" value of "No" and the input data type is CS16 (16-bit ints for I and 16-bits for Q) -- this saves a significant amount of data for the file upload. The output is a transport stream (TS), so the file can be saved with a .ts extension. Most video viewing software will be able to play this format.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/atsc-video-1.jpg" alt="Signal Spectrum" />
  <figcaption><b>FigureX</b>: Video channel 1 of the .TS file.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/atsc-audio-1.png" alt="Signal Spectrum" />
  <figcaption><b>FigureX</b>: Audio channel 1 of the .TS file.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/atsc-audio-1-spectrum.png" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: The frequency content of audio channel 1 of the .TS file.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/atsc-audio-1-subcarrier.jpg" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Flowgraph to downconvert and demodulate the audio signal on the ATSC audio track 1. This also stores it as a .WAV file, which can then be further processed in an audio program. The audio on the subcarrier is a time-reversed voice with the flag</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/atsc-audio-2-spectrum.png" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: The spectrogram of audio track 2. There's clearly something extra here.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/gr-atsc-audio-2-subcarrier.jpg" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Initial flowgraph to process the 17.5 kHz subcarrier on the ATSC signal audio track 2.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/gr-atsc-audio-2-bitstream.png" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Demodulated bitstream from the ATSC audio track 2 subcarrier.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/gr-atsc-audio-2-final.jpg" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Final flowgraph for recovering the flag from the subcarrier of the ATSC audio track 2.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/gr-atsc-audio-2-export-URH.jpg" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: A flowgraph for exporting to URH.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/urh-atsc-audio-2.png" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Universal Radio Hacker showing decoding of the ATSC audio track 2 subcarrier. The result is a string of ASCII text with the final flag.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/ntsc-spectrum.jpg" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Spectrum of the NTSC signal, with the relevant subcarriers labeled.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/gr-ntsc-audio.jpg" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Flowgraph to recover the main audio carrier from the NTSC signal. This time, I used the "Frequency Xlating FFT Filter" to shift and filter the audio carrier.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/ntsc-video-frame.png" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Display of NTSC video using GNURadio and the flowgraph above. The video showed up offset both horizontally and vertically, so the requisite controls were adjusted to center the display. Also, this is using "invert" video so that the grayscale is the original.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/gr-pal-audio.jpg" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Flowgraph to recover the audio from the PAL signal. Initially, the audio sounds strange, so I've put the audio into a waterfall display to see if it will tell us what is going on.</figcaption>
</figure>

<figure>
  <img src="/img/grcon25-ctf/gr-pal-audio-spectrum.png" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Spectrogram (top, aka "waterfall") of the audio output of the audio carrier, and spectrum of FM audio carrier (bottom). The waterfall shows that the energy is concentrated at the high end of the spectrum, as if the spectrum has been inverted.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/gr-pal-audio-fix.jpg" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Flowgraph to tune, filter, demodulate, and spectrally-invert the audio for the PAL audio carrier.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/gr-pal-video-final.jpg" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Flowgraph to tune, filter, demodulate, and spectrally-invert the audio for the PAL audio carrier.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/gr-pal-video-frame.png" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Display of the video from the PAL signal.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/sigid-pt1-overview.png" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: The overall spectrum of part 1 of the signal identification challenge.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/cw-decoding.png" alt="CW Decoding" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: The windows showing GQRX USB demodulated samples streamed over UDP to multimon-ng, which displays the scope view of the samples and decodes the morse code.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/gqrx-aprs-decode.png" alt="APRS Decoding" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: The AFSK1200 decoder in GQRX combined with a NBFM tuner.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/gqrx-dtmf.png" alt="DTMF Decoding" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Multimon-ng decodes DTMF receiving UDP packets from a USB or LSB decoder in GQRX.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/sdrangel-m17.png" alt="DTMF Decoding" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Decoding the M-17 signal in SDRAngel.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/sigid-pt2.png" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Spectrum of Signal Identification for Flags 6 - 13. These were all analog modulation schemes. From left to right, the signals were AM-USB-SC, wideband FM (mimicking a US FM broadcast station), AM-DSB-FC, AM-DSB-SC, narrowband FM, and AM-LSB-SC.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/sigid-pt2.png" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Spectrogram of the signal centered at roughly -300 kHz in the Signal ID challenge for flags 6 - 13. Note how the energy is concentrated on the lower frequency edge of the signal. This and the pattern (it's similar to the patten for speech) indicates an AM-LSB audio signal. And as there is no consistent line anywhere in the signal, it is also suppressed carrier.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/gr-am-lsb.jpg" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Flowgraph to recover the LSB signal centered at -300 kHz. The result is an audio signal containing the flag.</figcaption>
</figure>
...
<div className="row">
    <div className="column" style={{width: "100%"}}>
        <figure>
          <img src="/img/grcon25-ctf/gr-fm.jpg" alt="Signal Spectrum" />
          <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Flowgraph for determining the modulation of the wideband signal at -163 kHz. The filtered signal feeds into a QT GUI Constellation Sink.</figcaption>
        </figure>
    </div>
    <div className="column" style={{width: "100%"}}>
        <figure>
          <img src="/img/grcon25-ctf/gr-fm-const.png" alt="Signal Spectrum" />
          <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: The output of the constellation sink. The result is a signal whose phase is constantly changing, but whose amplitude (distance from the center of the display) is fixed. This constant envelope and variable phase appearance indicates frequency modulation (FM).</figcaption>
        </figure>
    </div>
</div>    
...
<figure>
  <img src="/img/grcon25-ctf/gqrx-rds.png" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: The GQRX menus for turning on RDBS decoding.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/gr-fm-demod.jpg" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Flowgraph to frequency demodulate the WBFM signal. Rather than using the WBFM Receive, FM Demod, or WBFM Receive PLL blocks (which would limit the output spectrum), I'm using the basic frequency demodulator block, the Quadrature Demod block.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/gr-fm-demod-spectrum.png" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Baseband spectrum of the WBFM signal. This spectrum shows a composite of several signals. This is identical to standard FM broadcast stations. Starting from 0 Hz, the signal from 0 - 15 kHz is an audio signal comprised of the left and right stereo signals added together, a 19 kHz sinusoid that is used to recover the next signal up, a 38 kHz AM-DSB-SC stereo signal comprised of the left and right signals with the right subtracted from the left, a 57 kHz Radio Data System (RDS) signal, and a Subsidiary Communications Authority (SCA) signal at 67 kHz. All the signals starting with the 19 kHz pilot signal are technically called "subcarriers", and provide different information.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/gr-fm-audio.jpg" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Flowgraph to recover the baseband (L+R) audio from the WBFM signal. This will recover Flag 6.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/gr-fm-stereo.jpg" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Flowgraph to recover the 38 kHz stereo subcarrier from the WBFM signal. For this specific signal, the recovery will be almost perfect, if not perfect. In the case of a stereo signal from an actual FM broadcast station, the recovery will be varying amplitude levels.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/gr-rds.jpg" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Flowgraph to demodulate and decode the RDS signal on the WBFM baseband.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/gr-fm-rds-raster.png" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: RDS readout and time raster of the bit stream synchronized to the 104-bit word length. The shift roughly halfway down the time raster is due to the signal file starting to repeat.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/gr-fm-sca.jpg" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Flowgraph to recover the SCA on the WBFM signal. The result is audio reading flag 8.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/am-dsb.png" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Spectrogram (top) and spectral trace (bottom) of the signal centered at ~ -2 kHz. The spectrogram and spectral trace show upper and lower sidebands that are varying up / down, indicating amplitude modulation (AM). They are also symmetrical (mirror images of each other), indicating double sideband. The consistent amplitude spectral line in the center indicates full carrier. So, this is a AM-DSB-FC signal.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/gr-am-dsb-demod.jpg" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Flowgraph to tune to and demodulate the signal centered at ~ -2 kHz of the SigID spectrum for flags 6 - 13. This was a AM-DSB-FC signal, meaning it could be demodulated using a "Complex to Mag" block. The result is an audio stream reading the flag.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/am-dsb-sc.png" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Spectrum of the signal centered at ~48.5 kHz.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/gr-am-dsb-sc.jpg" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Flowgraph to demodulate the signal centered at ~48.5 kHz. The signal is AM-DSB-SC.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/nbfm.png" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Spectrum of signal centered at ~108 kHz.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/gr-nbfm-demod.jpg" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: GNURadio flowgraph for demodulating the NBFM signal.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/gr-nbfm-demod.jpg" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Spectrum of signal centered at ~189 kHz.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/gr-am-lsb-demod.jpg" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Flowgraph to demodulate the AM LSB signal</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/gr-multi-tx.png" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Flowgraph to resample and combine several signals into a final broadband signal.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/radiant-spectrum.png" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: The spectrum of the radiant challenge.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/radiant-quad-demod.png" alt="Signal Spectrum" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Results of the quadrature demod.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/radiant-bitlen.png" alt="Bitlength" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: Measuring the bitlength by zooming in on a single bit. The time on the right is 153ms, while the time on the far left is 148ms. This gives a bit length of 5ms.</figcaption>
</figure>
...
<figure>
  <img src="/img/grcon25-ctf/radiant-flowgraph.png" alt="Flowgraph" />
  <figcaption style={{textAlign: "justify"}}><b>FigureX</b>: The final flowgraph. You will have to tinker with the skip head parameter to find the correct file length.</figcaption>
</figure>
