...
<figure>
  <img
    ...
    alt="Signal Spectrum" />
  <figcaption align="justify"><b>Figure 1</b>: Spectrum of the NTSC signal, with the relevant subcarriers labeled. 
    </figcaption>
</figure>
...
<figure>
  <img
    ...
    alt="Signal Spectrum" />
  <figcaption align="justify"><b>Figure 2</b>: Flowgraph to recover the main audio carrier from the NTSC signal. This time, I used the "Frequency Xlating FFT Filter" to shift and filter the audio carrier.
    </figcaption>
</figure>
...
<figure>
  <img
    ...
    alt="Signal Spectrum" />
  <figcaption align="justify"><b>Figure 5</b>: Display of NTSC video using GNURadio and the flowgraph above. The video showed up offset both horizontally and vertically, so the requisite controls were adjusted to center the display. Also, this is using "invert" video so that the grayscale is the original.
    </figcaption>
</figure>
...
<figure>
  <img
    ...
    alt="Signal Spectrum" />
  <figcaption align="justify"><b>Figure 6</b>: Flowgraph to recover the audio from the PAL signal. Initially, the audio sounds strange, so I've put the audio into a waterfall display to see if it will tell us what is going on.
    </figcaption>
</figure>
...
<figure>
  <img
    ...
    alt="Signal Spectrum" />
  <figcaption align="justify"><b>Figure 7</b>: Spectrogram (top, aka "waterfall") of the audio output of the audio carrier, and spectrum of FM audio carrier (bottom). The waterfall shows that the energy is concentrated at the high end of the spectrum, as if the spectrum has been inverted.
    </figcaption>
</figure>
...
<figure>
  <img
    ...
    alt="Signal Spectrum" />
  <figcaption align="justify"><b>Figure 8</b>: Flowgraph to tune, filter, demodulate, and spectrally-invert the audio for the PAL audio carrier.
    </figcaption>
</figure>
...
<figure>
  <img
    ...
    alt="Signal Spectrum" />
  <figcaption align="justify"><b>Figure 9</b>: Flowgraph to tune, filter, demodulate, and spectrally-invert the audio for the PAL audio carrier.
    </figcaption>
</figure>
...
<figure>
  <img
    ...
    alt="Signal Spectrum" />
  <figcaption align="justify"><b>Figure 10</b>: Display of the video from the PAL signal.
    </figcaption>
</figure>
...
<figure>
  <img
    ...
    alt="Signal Spectrum" />
  <figcaption align="justify"><b>Figure 11</b>:Spectrum of Signal Identification for Flags 6  - 13. These were all analog modulation schemes. From left to right, the signals were AM-USB-SC, wideband FM (mimicking a US FM broadcast station), AM-DSB-FC, AM-DSB-SC, narrowband FM, and AM-LSB-SC.</figcaption>
</figure>
...
<figure>
  <img
    src="assets/img/grcon25-ctf/sigid-pt2.png"
    alt="Signal Spectrum" />
  <figcaption align="justify"><b>Figure 12</b>:Spectrogram of the signal centered at roughly -300 kHz in the Signal ID challenge for flags 6 - 13. Note how the energy is concentrated on the lower frequency edge of the signal. This and the pattern (it's similar to the patten for speech) indicates an AM-LSB audio signal. And as there is no consistent line anywhere in the signal, it is also suppressed carrier.</figcaption>
</figure>
...
<figure>
  <img
    ...
    alt="Signal Spectrum" />
  <figcaption align="justify"><b>Figure 13</b>:Flowgraph to recover the LSB signal centered at -300 kHz. The result is an audio signal containing the flag.</figcaption>
</figure>
    ...
    <div class="column" style="width:100%">
        <figure>
          <img
            ...
            alt="Signal Spectrum" 
        />
          <figcaption align="justify"><b>Figure 14</b>:Flowgraph for determining the modulation of the wideband signal at -163 kHz. The filtered signal feeds into a QT GUI Constellation Sink.
        </figcaption>
        </figure>
    </div>
    <div class="column" style="width:100%">
        <figure>
          <img
            ...
            alt="Signal Spectrum" 
        />
          <figcaption align="justify"><b>Figure 15</b>:The output of the constellation sink. The result is a signal whose phase is constantly changing, but whose amplitude (distance from the center of the display) is fixed. This constant envelope and variable phase appearance indicates frequency modulation (FM).
        </figcaption>
        </figure>
    </div>
</div>    
...
<figure>
  <img
    ...
    alt="Signal Spectrum" 
/>
  <figcaption align="justify"><b>Figure 16</b>:This signal's phase is constantly changing, but its amplitude (distance from the center of the display) is fixed. This constant envelope and variable phase appearance indicates frequency modulation (FM).
</figcaption>
</figure>
...
<figure>
  <img
    ...
    alt="Signal Spectrum" 
/>
  <figcaption align="justify"><b>Figure 17</b>:Flowgraph to frequency demodulate the WBFM signal. Rather than using the WBFM Receive, FM Demod, or WBFM Receive PLL blocks (which would limit the output spectrum), I'm using the basic frequency demodulator block, the Quadrature Demod block.
</figcaption>
</figure>
...
<figure>
  <img
    ...
    alt="Signal Spectrum" 
/>
  <figcaption align="justify"><b>Figure 19</b>:Flowgraph to recover the baseband (L+R) audio from the WBFM signal. This will recover Flag 6.
</figcaption>
</figure>
...
<figure>
  <img
    ...
    alt="Signal Spectrum" 
/>
  <figcaption align="justify"><b>Figure 20</b>:Flowgraph to recover the 38 kHz stereo subcarrier from the WBFM signal. For this specific signal, the recovery will be almost perfect, if not perfect. In the case of a stereo signal from an actual FM broadcast station, the recovery will be varying amplitude levels.
</figcaption>
</figure>
...
<figure>
  <img
    ...
    alt="Signal Spectrum" 
/>
  <figcaption align="justify"><b>Figure 21</b>:Flowgraph to demodulate and decode the RDS signal on the WBFM baseband.
</figcaption>
</figure>
...
<figure>
  <img
    ...
    alt="Signal Spectrum" 
/>
  <figcaption align="justify"><b>Figure 22</b>:RDS readout and time raster of the bit stream synchronized to the 104-bit word length. The shift roughly halfway down the time raster is due to the signal file starting to repeat.
</figcaption>
</figure>
...
<figure>
  <img
    ...
    alt="Signal Spectrum" 
/>
  <figcaption align="justify"><b>Figure 23</b>:Flowgraph to recover the SCA on the WBFM signal. The result is audio reading flag 8. 
</figcaption>
</figure>
...
<figure>
  <img
    ...
    alt="Signal Spectrum" 
/>
  <figcaption align="justify"><b>Figure 25</b>:Flowgraph to tune to and demodulate the signal centered at ~ -2 kHz of the SigID spectrum for flags 6 - 13. This was a AM-DSB-FC signal, meaning it could be demodulated using a "Complex to Mag" block. The result is an audio stream reading the flag.
</figcaption>
</figure>
...
<figure>
  <img
    ...
    alt="Signal Spectrum" 
/>
  <figcaption align="justify"><b>Figure 26</b>:Spectrum of the signal centered at ~48.5 kHz. 
</figcaption>
</figure>
...
<figure>
  <img
    ...
    alt="Signal Spectrum" 
/>
  <figcaption align="justify"><b>Figure 27</b>:Flowgraph to demodulate the signal centered at ~48.5 kHz. The signal is AM-DSB-SC. 
</figcaption>
</figure>
...
<figure>
  <img
    ...
    alt="Signal Spectrum" 
/>
  <figcaption align="justify"><b>Figure 28</b>:Spectrum of signal centered at ~108 kHz.
</figcaption>
</figure>
...
<figure>
  <img
    ...
    alt="Signal Spectrum" 
/>
  <figcaption align="justify"><b>Figure 29</b>:GNURadio flowgraph for demodulating the NBFM signal.
</figcaption>
</figure>
...
<figure>
  <img
    ...
    alt="Signal Spectrum" 
/>
  <figcaption align="justify"><b>Figure 30</b>:Spectrum of signal centered at ~189 kHz. 
</figcaption>
</figure>
...
<figure>
  <img
    ...
    alt="Signal Spectrum" 
/>
  <figcaption align="justify"><b>Figure 31</b>:Flowgraph to demodulate the AM LSB signal 
</figcaption>
</figure>
...
<figure>
  <img
    ...
    alt="Signal Spectrum" 
/>
  <figcaption align="justify"><b>Figure 32</b>:Flowgraph to resample and combine several signals into a final broadband signal. 
</figcaption>
</figure>
